...
**거의 다 끝났습니다.** 아래는 이미 완료된 항목입니다.

| | 항목 | 상태 |
|---|---|---|
| 1 | Supabase 무료 조직 `mdmiraecell` | ✅ |
| 2 | 프로젝트 (서울 리전) · `ghfoffpgkftudwfpldua` | ✅ |
| 3 | 표 4개 + 접근 권한 + RLS | ✅ |
| 4 | 접수 함수 `submit-consultation` | ✅ ACTIVE |
| 5 | `js/config.js` 주소·공개키 | ✅ |
| 6 | 관리자 계정 (`mdmiraecellclinic@gmail.com`, owner) | ✅ |
| 7 | 회원가입 차단 | ✅ |
| 8 | 함수 환경변수 5개 (Resend 알림 포함) | ✅ |
| 9 | 개인정보처리방침 본문 | ✅ 초안 확정 |
...
| | 항목 | 필수 | 문서 |
|---|---|---|---|
| ⓐ | GitHub keepalive 시크릿 2개 등록 | **필수** | 8번 |
| ⓑ | 카페24에 사이트 올리고 실제 접수 테스트 | **필수** | 9번 |

> 방침의 **보호책임자(박종윤 대표원장)** 와 **시행일(2026-09-22)** 은 제안값입니다.
> 게시 전 원장님 확인을 받으십시오.
